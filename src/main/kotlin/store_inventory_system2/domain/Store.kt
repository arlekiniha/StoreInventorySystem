...
class Store(
    ...
    fun addItem(itemName: String, itemPrice: Int, quantity: Int): Boolean {
        ...
        transactionsRepository.addTransaction(
            transaction = Transaction("You added $itemName, $itemPrice, $quantity units", TransactionType.Admin)
        )
    ...
    fun restockItem(itemName: String, quantity: Int): Boolean {
        ...
        transactionsRepository.addTransaction(
            transaction = Transaction("You restocked $itemName by $quantity", TransactionType.Admin)
        )
